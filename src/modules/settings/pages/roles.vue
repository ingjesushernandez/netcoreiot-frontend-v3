          ...
          <div class="card">
            ...
            <div class="card-body pt-0 px-0">
              ...
              >
                ...
                <template #item-isSystem="{ isSystem }">
                  <span :class="isSystem ? 'badge bg-secondary' : 'badge bg-light text-muted'">
                    {{ isSystem ? "Sí" : "No" }}
                  </span>
                </template>
                ...
                <template #item-actions="{ _id, isSystem }">
                  <div class="d-flex justify-content-start gap-2">
                    ...
                    <SharedButton
                      ...
                      :disabled="isSystem"
                      :perms="['role:delete']"
                      @click="handleDelete(_id, isSystem)"
                    />
                  </div>
                </template>
